/*
  Class: CMSC140 CRN 16471
  Instructor: Rabiya Kayed
  Project<1>
  Description: A departement is about to purchase a humanoid robot. This program shows a greeting script between the robot and the visitor.
  Due Date: 7/25/2020
  I pledge that I have completed the programming assignment independently.
  I have not copied the code from a student or any source.
  I have not given my code to any student.
  Print your Name here: Sakina Lougue prisca
