/*
* Class: CMSC1 40 CRN 14671
* Instructor:Rahiba Kayed
* Project<4>
* Description: This program calculates the average number of days a company employees are absent
			   during the year and output a report on a file named "employeeAbsences.txt".
* Due Date: August, 13th, 2020
* I pledge that I have completed the programming assignment independently.
   I have not copied the code from a student or any source.
   I have not given my code to any students
*  Print your Name here: Sakina Lougue
*/
